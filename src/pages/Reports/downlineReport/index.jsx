...
import DownlineReportTable from "./components/table";
import { useSelector } from "react-redux";
import { useQuery } from "@tanstack/react-query";
import { getDownlineStockInOutReport } from "../../../services/reports_service.js";
...
function DownlineReport() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["downlinestockinoutReport", filter, refetch],
    queryFn: () => getDownlineStockInOutReport(filter),
  });
