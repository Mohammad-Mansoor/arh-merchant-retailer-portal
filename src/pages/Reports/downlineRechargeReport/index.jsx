...
function DownlineRechargeReport() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["getDownlineRechargeLogReport", filter, refetch],
    queryFn: () => getDownlineRechargeLogReport(filter),
  });
...
export default DownlineRechargeReport;
