...
import TopupRechargeReportTable from "./components/table";
...
function TopupRechargeReport() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["rechargeLogReport", filter, refetch],
    queryFn: () => getRechargeLogReport(filter),
  });
  const handleRefetch = () => {
...
export default TopupRechargeReport;
