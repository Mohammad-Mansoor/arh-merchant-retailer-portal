...
import DownlineProductActivationTable from "./components/table.jsx";
import { useSelector } from "react-redux";
import { useQuery } from "@tanstack/react-query";
import {
  getDownlineProductActivationReport,
  getDownlineStockInOutReport,
} from "../../../services/reports_service.js";
import { handleSetSearch } from "../../../utils/searchDebouncing";

function DownlineProductActivation() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["getDownlineProductActivationReport", filter, refetch],
    queryFn: () => getDownlineProductActivationReport(filter),
  });
  ...
  return (
    ...
    >
      ...
      {/* table section */}
      <div className="mt-5">
        <DownlineProductActivationTable
          data={data?.data || []}
          isLoading={isLoading}
          isError={isError}
...
export default DownlineProductActivation;
