...
import StockInOutReportTable from "./components/table";
import { useSelector } from "react-redux";
import { useQuery } from "@tanstack/react-query";
import { getStockInOutReport } from "../../../services/reports_service.js";
import { handleSetSearch } from "../../../utils/searchDebouncing.js";

function StockOutInReport() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["stockinoutReport", filter, refetch],
    queryFn: () => getStockInOutReport(filter),
  });
  const handleRefetch = () => {
...
export default StockOutInReport;
