...
import RechargeTable from "./components/table";
...
function Recharge() {
  ...
  return (
    <div className="w-full px-5 py-4 h-[200px]]">
      ...
      <div className="w-full flex items-center justify-between gap-5 mt-5">
        <div className="flex items-center justify-start w-[70%] gap-5">
          <div className="max-w-[371px] w-[80%] h-[44px] relative  dark:text-white dark:to-slate-800 rounded-md border border-[#E4E7EC] dark:border-gray-500 ">
            <input
              onChange={(e) => {
