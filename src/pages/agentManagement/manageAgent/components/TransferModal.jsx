  ...
  return (
    <StyledDialog open={open} onClose={onClose}>
      <SuccessModal
        ...
        onClose={() => setIsTransferSuccess(false)}
        amount={amount}
      />
      <ErrorModal
        open={isError}
      ...
      <div className="px-5 py-3">
        ...
        {/* Form Fields are reused from your original code but each with error and value handling now */}
        {/* Only show fields setup here if needed; omitted for brevity */}
