              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center">
                  <Checkbox
                    ...
                    className="group size-6 rounded-md bg-[#cd0202] p-1 ring-1 cursor-pointer ring-[#cd0202] ring-inset focus:not-data-focus:outline-none data-checked:bg-white data-focus:outline data-focus:outline-offset-2 data-focus:outline-white"
                  >
                    <CheckIcon
                      className={`size-4 fill-[#cd0202] group-data-checked:fill-[#fff] ${
